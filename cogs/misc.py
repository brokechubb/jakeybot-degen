...
class Misc(commands.Cog):
    ...
    async def _auto_generate_image(self, message, prompt: str):
        ...
        try:
            ...
            model_name = environ.get("DEFAULT_GEMINI_IMAGE_GENERATION_MODEL", "gemini-2.0-flash-exp")
            if not model_name or model_name == "gemini-model-id":
                model_name = "gemini-2.0-flash-exp"  # Fallback to a model that supports image generation

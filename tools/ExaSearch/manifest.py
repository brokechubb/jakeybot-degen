class ToolManifest:
    ...
    web_search_tool_description = (
        "Search the web to inform response, use semantic or keyword based search."
    )
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "searchType": {
                            ...
                            "description": "The type of search to perform, use keyword to include keywords in the search query, neural for specific searches, or auto to let the service automatically determine the best type. Defaults to auto.",
                        },
                        "numResults": {
                            "type": "integer",
